...
config :plug_http_cache_demo, :plug_http_cache_opts, %{store: :http_cache_store_memory}

config :http_cache_store_memory, :memory_limit, 1024 * 1024 * 120
config :http_cache_store_memory, :cluster_enabled, true
